            ...
            <div className="container-fluid py-5 mb-5">
                <div className="row">
                    ...
                    <div className="col-md-9">
                        <h5 className='bg-primary text-light text-center p-2'> <Link to="/admin/brand"><i className='fa fa-arrow-left text-light float-end '></i></Link>Brand</h5>
                        <form onSubmit={postSubmit}>
                            <div className="mb-3">
                                <label >Name*</label>
                                <input type="text" name='name' onChange={getInputDat} placeholder='Brand Name' className={`form-control border-2 ${show && error.name ? 'border-danger' : 'border-primary'}`} />
