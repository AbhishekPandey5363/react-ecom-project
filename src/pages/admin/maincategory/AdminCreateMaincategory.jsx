            ...
            <div className="container-fluid py-5 mb-5">
                <div className="row">
                    ...
                    <div className="col-md-9">
                        <h5 className='bg-primary text-light text-center p-2'> <Link to="/admin/maincategory"><i className='fa fa-arrow-left text-light float-end '></i></Link>Maincategory</h5>
                        <form onSubmit={postSubmit}>
                            <div className="mb-3">
                                <label >Name*</label>
                                <input type="text" name='name' onChange={getInputDat} placeholder='Maincategory Name' className={`form-control border-2 ${show && error.name ? 'border-danger' : 'border-primary'}`} />
                            ...
                            <div className="row">
                                <div className="col-md-6 mb-6">
                                    <label >Pic*</label>
                                    <input type="file" name='pic' onChange={getInputDat} className={`form-control border-2 ${show && error.pic ? 'border-danger' : 'border-primary'}`} />
                                    {show && error.pic ? <p className='text-danger text-capitalize'>{error.pic}</p> : null}
                                </div>

                                <div className="col-md-6 mb-3">
                                    <label >Active*</label>
                                    <select name="active" onChange={getInputDat} className='form-select border-2 border-primary'>
