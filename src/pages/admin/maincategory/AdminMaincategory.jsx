                                ...
                                <tbody>
                                    {
                                        MaincategoryStateData.map((item) => {
                                            ...
                                            return <tr key={item.id}>
                                                ...
                                                <td>{item.name}</td>
                                                <td>
                                                    <Link to={`${process.env.REACT_APP_BACKEND_SERVER}/${item.pic}`} target='_blank' rel='norefererror'>
                                                        <img src={`${process.env.REACT_APP_BACKEND_SERVER}/${item.pic}`} height={50} width={80} alt="" />
                                                    </Link>
                                                </td>
                                                <td className={`${item.active ? 'text-success' : 'text-danger'}`}>{item.active ? "Yes" : "No"}</td>
                                                <td><Link to={`/admin/maincategory/update/${item.id}`} className='btn btn-primary fs-4'><i className='fa fa-edit fs-4'></i></Link></td>
                                                ...
                                                {/* <td><Link to={`/admin/maincategory/update/${item._id}`} className='btn btn-primary fs-4'><i className='fa fa-edit fs-4'></i></Link></td>
