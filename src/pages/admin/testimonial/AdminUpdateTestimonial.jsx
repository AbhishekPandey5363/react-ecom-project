    ...
    useEffect(() => {
        (() => {
            ...
            if (TestimonialStateData.length) {
                ...
                // let item = TestimonialStateData.find(x => x.id === _id) in case of real realbackend
                if (item)
                    setData({ ...item })
            }
        })()
                ...
                <div className="row">
                    ...
                    <div className="col-md-9">
                        ...
                        <form onSubmit={postSubmit}>
                            ...
                            <div className="mb-3">
                                <label>Message*</label>
                                <textarea name="message" value={data.message} onChange={getInputData} className={`form-control border-2 ${show && error.message ? 'border-danger' : 'border-primary'}`} placeholder='Message...' rows={4}></textarea>
