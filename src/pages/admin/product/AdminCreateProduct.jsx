            ...
            <div className="container-fluid py-5 mb-5">
                <div className="row">
                    ...
                    <div className="col-md-9">
                        <h5 className='bg-primary text-light text-center p-2'> <Link to="/admin/product"><i className='fa fa-arrow-left text-light float-end '></i></Link>Product</h5>
                        <form onSubmit={postSubmit}>
                            <div className="mb-3">
                                <label >Name*</label>
                                <input type="text" name='name' onChange={getInputData} placeholder='Product Name' className={`form-control border-2 ${show && error.name ? 'border-danger' : 'border-primary'}`} />
                            ...
                            <div className="row">
                                <div className="col-md-6 mb-3">
                                    <label>Color*</label>
                                    <input type="text" name='color' onChange={getInputData} placeholder='Product Color' className={`form-control border-2 ${show && error.color ? 'border-danger' : 'border-primary'}`} />
                                    {show && error.color ? <p className='text-danger text-capitalize'>{error.name}</p> : null}
                                </div>

                                <div className="col-md-6 mb-3">
                                    <label>Size*</label>
                                    <input type="text" name='size' onChange={getInputData} placeholder='Product Size' className={`form-control border-2 ${show && error.size ? 'border-danger' : 'border-primary'}`} />
                            ...
                            <div className="row">
                                <div className="col-md-6 mb-3">
                                    ...
                                    <input type="number" name='basePrice' onChange={getInputData} placeholder='Product Base Price' className={`form-control border-2 ${show && error.basePrice ? 'border-danger' : 'border-primary'}`} />
                                    {show && error.basePrice ? <p className='text-danger text-capitalize'>{error.basePrice}</p> : null}
                                </div>
                                <div className="col-md-6 mb-3">
                                    <label>Discount*</label>
                                    <input type="number" name='discount' onChange={getInputData} placeholder='Discount' className={`form-control border-2 ${show && error.discount ? 'border-danger' : 'border-primary'}`} />
                            ...
                            <div className="row">
                                <div className="col-md-6 mb-3">
                                    ...
                                    <input type="number" name='stockQuantity' onChange={getInputData} placeholder='Stock Quantity' className={`form-control border-2 ${show && error.stockQuantity ? 'border-danger' : 'border-primary'}`} />
