                                ...
                                <tbody>
                                    {
                                        UserStateData.map((item) => {
                                            ...
                                            return <tr key={item.id}>
                                                ...
                                                <td>{localStorage.getItem("role") === "Super Admin" && item.role !== "Buyer" ? <Link to={`/admin/user/update/${item.id}`} className='btn btn-primary fs-4'><i className='fa fa-edit fs-4'></i></Link> : null}</td>
                                                ...
                                                {/* <td><Link to={`/admin/user/update/${item._id}`} className='btn btn-primary fs-4'><i className='fa fa-edit fs-4'></i></Link></td>
