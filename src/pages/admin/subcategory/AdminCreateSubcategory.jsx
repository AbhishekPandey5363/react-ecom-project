            ...
            <div className="container-fluid py-5 mb-5">
                <div className="row">
                    ...
                    <div className="col-md-9">
                        <h5 className='bg-primary text-light text-center p-2'> <Link to="/admin/subcategory"><i className='fa fa-arrow-left text-light float-end '></i></Link>Subcategory</h5>
                        <form onSubmit={postSubmit}>
                            <div className="mb-3">
                                <label >Name*</label>
                                <input type="text" name='name' onChange={getInputData} placeholder='Subcategory Name' className={`form-control border-2 ${show && error.name ? 'border-danger' : 'border-primary'}`} />
