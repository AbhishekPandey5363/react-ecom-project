    ...
    async function postData(e) {
        ...
        try {
            ...
            if (item && item.active === false) {
                setErrorMessage("Your Account id not Active. Please Contact us for More Details and To Activate Your Account Please Provide Your Username or Registered Email Address in Contact us Query")
            }
            else if (item) {
