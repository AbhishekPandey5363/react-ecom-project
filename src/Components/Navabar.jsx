                ...
                <div className="container">
                    <div className="d-flex justify-content-between topbar">
                        <div className="top-info">
                            <small className="me-3 text-white-50"><Link to="mailto:abhishekpandey6075@gmail.com" target='_blank' rel='noreferrer' className='text-light'><i className="fas fa-envelope me-2 text-secondary"></i> <span className='d-none d-lg-inline'>abhishekpandey6075@gmail.com</span></Link></small>
                            <small className="me-3 text-white-50"><Link to="tel:+916386536398" target='_blank' rel='noreferrer' className='text-light'><i className="fas fa-phone me-2 text-secondary"></i> <span className='d-none d-lg-inline'>+91-6386536398</span></Link></small>
                            <small className="me-3 text-white-50"><Link to="https://wa.me/+916386536398" target='_blank' rel='noreferrer' className='text-light'><i className="fa fa-whatsapp fs-5 me-2 text-secondary"></i> <span className='d-none d-lg-inline'>+91-6386536398</span></Link></small>
                        </div>
                    ...
                    <nav className="navbar navbar-dark navbar-expand-lg py-0">
                        ...
                        <div className="d-none d-xl-flex flex-shirink-0">
                            ...
                            <div className="d-flex flex-column">
                                ...
                                <span className="text-secondary">Call: <Link to="tel:+916386536398" className='text-light' target='_blank' rel='noreferrer'>+91-6386536398</Link></span>
                            </div>
                        </div>
                        <div className="collapse navbar-collapse bg-transparent" id="navbarCollapse">
                            <div className="navbar-nav ms-auto mx-xl-auto p-0">
