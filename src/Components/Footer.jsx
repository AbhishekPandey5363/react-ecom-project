            ...
            <div className="container-fluid footer bg-dark wow fadeIn" data-wow-delay=".3s">
                <div className="row g-5">
                    <div className="col-lg-2 col-md-6">
                        ...
                        <p className="mt-4 text-light">We Provide upto 90% Discount on Top Brands Product and We deals in Kids, Female Male products</p>
                    ...
                    <div className="col-lg-3 col-md-6">
                        ...
                        <div className="text-white mt-4 d-flex flex-column contact-link">
                            ...
                            <Link to="tel:+916386536398" target='_blank' rel='noreferror' className="py-3 text-light border-bottom border-primary"><i className="fas fa-phone-alt text-secondary me-2"></i>+91-6386536398</Link>
                            <Link to="https://wa.me/+916386536398" target='_blank' rel='noreferror' className="py-3 text-light border-bottom border-primary"><i className="fa fa-whatsapp text-secondary me-2 fs-5"></i>+91-6386536398</Link>
                            <Link to="maito:abhishekpandey6071@gmail.com" target='_blank' rel='noreferror' className="py-3 text-light border-bottom border-primary"><i className="fas fa-envelope text-secondary me-2"></i> abhishekpandey6071@gmail.com</Link>
                        </div>
                    </div>
                    ...
                    <div className="col-lg-2 col-md-6">
                        ...
                        <div className="mt-4 d-flex flex-column short-link">
                            ...
                            <Link to="/tetimonial" className="mb-2 text-white"><i className="fas fa-angle-right text-secondary me-2"></i>Testimonial</Link>
                        </div>
                    </div>
                    <div className="col-lg-2 col-md-6">
                        <h3 className="h3 text-secondary">Quick Link</h3>
                        <div className="mt-4 d-flex flex-column short-link">
                            ...
                            <Link to="#" className="mb-2 text-white"><i className="fas fa-angle-right text-secondary me-2"></i>Teams & Conditions</Link>
                    ...
                    <div className="col-lg-3 col-md-12">
                        <h3 className="h3 text-secondary">New letter</h3>
                        ...
                        <form onSubmit={postData}>
                            <div className="mb-3">
                                <input type="text" name='email' onChange={(e) => setEmail(e.target.value)} placeholder='Email Address' className='form-control' />
                            </div>
                            <button className='btn btn-secondary w-100' type='sumbit'>Subscribe</button>
                        </form>
                    </div>
