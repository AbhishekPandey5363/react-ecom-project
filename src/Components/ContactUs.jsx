                            ...
                            <div className="col-lg-6 col-md-6 wow fadeIn" data-wow-delay=".3s">
                                <div className="d-flex bg-light p-3 rounded">
                                    ...
                                    <div className="ms-3">
                                        ...
                                        <a href="https://www.google.com/maps/place/DUCAT/@28.5798005,77.3120918,17z/data=!3m1!4b1!4m6!3m5!1s0x390ce5106f125cfb:0xc516eda25aa8482c!8m2!3d28.5797958!4d77.3146667!16s%2Fg%2F1tcvmnf2?entry=ttu&g_ep=EgoyMDI1MDEyOC4wIKXMDSoASAFQAw%3D%3D" target="_blank" onChange={getInputData} value={data.name} className="">A-43, Sector 16, Noida </a>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-6 col-md-6 wow fadeIn" data-wow-delay=".5s">
                                <div className="d-flex bg-light p-3 rounded">
                                    ...
                                    <div className="ms-3">
                                        ...
                                        <a className="" href="tel:+916386536398" target="_blank">+91-6386536398</a>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-6 col-md-6 wow fadeIn" data-wow-delay=".5s">
                                <div className="d-flex bg-light p-3 rounded">
                                    ...
                                    <div className="ms-3">
                                        ...
                                        <a className="" href="https://wa.me/+916386536398" target="_blank">+91-6386536398</a>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-6 col-md-6 wow fadeIn" data-wow-delay=".7s">
                                <div className="d-flex bg-light p-3 rounded">
                                    <div className="flex-shrink-0 btn-square bg-secondary rounded-circle" style={{ width: "64px", height: "64px" }}>
                                    ...
                                    <div className="ms-3">
                                        ...
                                        <a className="" href="mailto:abhishekpandey60711@gmail.com" target="_blank">abhishekpandey60711@gmail.com</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="col-lg-6 col-md-6 wow fadeIn" data-wow-delay=".5s">
                                <div className="p-5 rounded contact-form">
                                    ...
                                    <form onSubmit={postData}>
                                        ...
                                        <div className="mb-4">
                                            <input type="email" name='email' onChange={getInputData} value={data.email} className={`form-control border-3 ${show && errorMessage.email ? 'border-danger' : 'border-success'} py-2`} placeholder={show && errorMessage.email ? "Email Address Field is Mendatory" : "Your Email Address"} />
                                        </div>
                                        <div className="mb-4">
                                        ...
                                        <div className="mb-4">
                                            <textarea name='message' className={`w-100 form-control border-3 ${show && errorMessage.message ? 'border-danger' : 'border-success'} py-2`} rows="4" onChange={getInputData} value={data.message} cols="10" placeholder={show && errorMessage.message ? "Message Field is Mendatory" : "Message"}></textarea>
                                        </div>
